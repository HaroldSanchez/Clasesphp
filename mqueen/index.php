            ...
            <form action="./config/insertar.php" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 ">
                        <input type="text"   class="form-control" id="vehiculo"    name="vehiculo"    placeholder="Marca Del Coche">
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        <input type="number" class="form-control" id="numerocompetidor"       name="numerocompetidor"       placeholder="Numero del Competidor">
                    </div>
