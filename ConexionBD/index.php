        ...
        <div class="card-body">
            ...
            <?php
                if (isset($_GET['confirm'])) {
                    ...
                    if ($_GET['confirm'] === "0") {
                        echo '<div class="alert alert-danger" role="alert"> <h4>Datos no ha ingresados<h4> </div>';
                    }
                    if ($_GET['confirm'] === "1") {
                        echo '<div class="alert alert-success" role="alert"> <h4>datos ingresidados correctamente<h4> </div>';
                    }
                    if ($_GET['confirm'] === "2") {
